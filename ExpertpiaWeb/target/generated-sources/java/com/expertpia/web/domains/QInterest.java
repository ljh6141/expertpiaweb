...
public class QInterest extends EntityPathBase<Interest> {
    ...
    private static final long serialVersionUID = 106263648L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QInterest interest = new QInterest("interest");

    public final NumberPath<Long> interId = createNumber("interId", Long.class);

    public final StringPath interName = createString("interName");
